@REM gosrc2cpg launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM GOSRC2CPG_config.txt found in the GOSRC2CPG_HOME.
...
if "%GOSRC2CPG_HOME%"=="" (
  ...
  set "GOSRC2CPG_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%GOSRC2CPG_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\GOSRC2CPG_config.txt"
set CFG_OPTS=
...
set "APP_CLASSPATH="
set "APP_MAIN_CLASS=-jar "%APP_LIB_DIR%\io.joern.gosrc2cpg-4.0.64-launcher.jar""
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running gosrc2cpg.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !GOSRC2CPG_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
