@REM swiftsrc2cpg launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM SWIFTSRC2CPG_config.txt found in the SWIFTSRC2CPG_HOME.
...
if "%SWIFTSRC2CPG_HOME%"=="" (
  set "APP_HOME=%~dp0\\.."

  rem Also set the old env name for backwards compatibility
  set "SWIFTSRC2CPG_HOME=%~dp0\\.."
) else (
  set "APP_HOME=%SWIFTSRC2CPG_HOME%"
)
...
set "CFG_FILE=%APP_HOME%\SWIFTSRC2CPG_config.txt"
set CFG_OPTS=
...
set "APP_CLASSPATH="
set "APP_MAIN_CLASS=-jar "%APP_LIB_DIR%\io.joern.swiftsrc2cpg-4.0.64-launcher.jar""
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running swiftsrc2cpg.
  echo.
...
"%_JAVACMD%" !_JAVA_OPTS! !SWIFTSRC2CPG_OPTS! -cp "%APP_CLASSPATH%" %MAIN_CLASS% !_APP_ARGS!
